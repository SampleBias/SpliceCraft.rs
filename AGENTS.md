...
1. Open [`docs/stages/STATUS.md`](docs/stages/STATUS.md). The first stage that
   is not `done` is the only stage you implement. Stages **17–20** are the
   UI polish track ([`docs/theme.md`](docs/theme.md)). If 00–20 are all done,
   do not invent a stage 21 — remaining work is ordinary issues in
